...
var enemy_x_min_offset = 1;
var enemy_x_max_offset = -1;
...
Player.prototype.CheckCollisions = function () {
    if(pause_play === false) {
        ...
        var player_x_max = this.x + player.player_width + player_x_max_offset;
        var player_y_min = this.y + player_y_min_offset;
        var player_y_max = this.y + player.player_height + player_y_max_offset;
